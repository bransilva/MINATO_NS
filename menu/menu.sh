...
permission_file=$(curl -sSL --connect-timeout 10 https://raw.githubusercontent.com/bransilva/lucki756.v/refs/heads/main/permission)
...
clear;clear;clear
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}            ${WH}• MINATO_NS PREMIUN •            ${NC} $COLOR1│ $NC"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
...
echo -e "${CYAN}│ELIGE UN NÚMERO${NC} ${MAGENTA}[12] ${YELLOW}🔍 VISUALIZANDO EL ESTADO DEL USUARIO EN LÍNEA${NC}│"
echo -e "${YELLOW}╰══${GREEN}==================${BLUE}══=======${PURPLE}══════════════════════${RED}╯${NC}"

echo -e "${MAGENTA}╭═══════${CYAN}══════ • ${RED}GENOM SCRIPT PRO${BLUE} • ${GREEN}═══════════════╮${NC}"
echo -e "${YELLOW}│ELIGE UN NÚMERO${NC} ${CYAN}  [15]    ${WH}🧬 AKSESS GENOM PRO ADMIN 🧬${NC}│"
...
echo -e "$COLOR1│ $NC ${WH}Author        ${COLOR1}: ${WH}MINATO_NS-{-->STORE${NC}$COLOR1"
